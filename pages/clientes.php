...
$clientes = mysql_query($query_limit_clientes, $sistemapacgrafica) or die(mysql_error());
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-3"><?php echo $row_clientes['Nombre']; ?></div>
                    <div class="col-xs-6 col-sm-3"><?php echo $row_clientes['Telefono']; ?></div>
                    <div class="col-xs-6 col-sm-3"><?php echo $row_clientes['Email']; ?></div>
                    <div class="col-xs-6 col-sm-3"><?php echo $row_clientes['Tipocliente']; ?></div>
