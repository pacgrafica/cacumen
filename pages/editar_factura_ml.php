...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE clientes SET Nombre=%s, Identificacion=%s, Direccion=%s, Email=%s, Telefono=%s, Fecha=%s, Factura=%s, Tipocliente=%s, Cantidad=%s, Descripcion=%s, PrecioUni=%s, PrecipTotal=%s, Precioletra=%s, SubTotal=%s, Iva=%s, Total=%s WHERE Id_cliente=%s",
