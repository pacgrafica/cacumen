                  ...
                  <table border="0">
                    <tr>
                      <td><?php if ($pageNum_facturaspacgrafica > 0) { // Show if not first page ?>
                          <a href="<?php printf("%s?pageNum_facturaspacgrafica=%d%s", $currentPage, 0, $queryString_facturaspacgrafica); ?>">Primero</a>
                          <?php } // Show if not first page ?></td>
                      <td><?php if ($pageNum_facturaspacgrafica > 0) { // Show if not first page ?>
                          <a href="<?php printf("%s?pageNum_facturaspacgrafica=%d%s", $currentPage, max(0, $pageNum_facturaspacgrafica - 1), $queryString_facturaspacgrafica); ?>">Anterior</a>
                          <?php } // Show if not first page ?></td>
                      <td><?php if ($pageNum_facturaspacgrafica < $totalPages_facturaspacgrafica) { // Show if not last page ?>
                          <a href="<?php printf("%s?pageNum_facturaspacgrafica=%d%s", $currentPage, min($totalPages_facturaspacgrafica, $pageNum_facturaspacgrafica + 1), $queryString_facturaspacgrafica); ?>">Siguiente</a>
                          <?php } // Show if not last page ?></td>
                      <td><?php if ($pageNum_facturaspacgrafica < $totalPages_facturaspacgrafica) { // Show if not last page ?>
                          <a href="<?php printf("%s?pageNum_facturaspacgrafica=%d%s", $currentPage, $totalPages_facturaspacgrafica, $queryString_facturaspacgrafica); ?>">&Uacute;ltimo</a>
                          <?php } // Show if not last page ?></td>
                    </tr>
                  </table>
            </div>
