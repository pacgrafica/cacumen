      ...
      <div class="btn-group btn-group-justified" role="group" aria-label="...">
        <?php do { ?>
          <div class="btn-group" role="group">
            <a href="editar_plan.php?recordID=<?php echo $row_plantucarro['Id_tarifa']; ?>"><button type="button" class="btn btn-default"><?php echo $row_plantucarro['Tipo']; ?></button></a>
          </div>
  ...
  <a href="#" class="list-group">
    <img src="../../images/tuinmueble.png" width="300" height="54"> </a>
      <div class="btn-group btn-group-justified" role="group" aria-label="...">
          ...
          <?php do { ?>
            <div class="btn-group" role="group">
              <a href="editar_plan.php?recordID=<?php echo $row_plantuinmueble['Id_tarifa']; ?>"><button type="button" class="btn btn-default"><?php echo $row_plantuinmueble['Tipo']; ?></button></a>
            </div>
  ...
  <a href="#" class="list-group">
    <img src="../../images/tumoto.png" width="300" height="41"> </a>
      <div class="btn-group btn-group-justified" role="group" aria-label="...">
            ...
            <?php do { ?>
              <div class="btn-group" role="group">
                <a href="editar_plan.php?recordID=<?php echo $row_plantumoto['Id_tarifa']; ?>"><button type="button" class="btn btn-default"><?php echo $row_plantumoto['Tipo']; ?></button></a>
              </div>
