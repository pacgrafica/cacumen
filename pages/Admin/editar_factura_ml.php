...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE clientes SET Nombre=%s, Identificacion=%s, Direccion=%s, Email=%s, Telefono=%s, Fecha=%s, Factura=%s, Tipocliente=%s, Cantidad=%s, Descripcion=%s, PrecioUni=%s, PrecipTotal=%s, Precioletra=%s, SubTotal=%s, Iva=%s, Total=%s, Estado=%s WHERE Id_cliente=%s",
  ...
  $updateGoTo = "facturas_tucarro.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$varcliente_editarfactura = "0";
if (isset($_GET["recordID"])) {
  $varcliente_editarfactura = $_GET["recordID"];
}
mysql_select_db($database_sistemapacgrafica, $sistemapacgrafica);
$query_editarfactura = sprintf("SELECT * FROM clientes WHERE clientes.Id_cliente = %s", GetSQLValueString($varcliente_editarfactura, "text"));
...
<div class="row">
  ...
  <textarea name="Descripcion" cols="50" rows="5" class="form-control"><?php echo htmlentities($row_editarfactura['Descripcion'], ENT_COMPAT, 'utf-8'); ?></textarea>
  ...
  <input type="text" name="PrecioUni" value="<?php echo htmlentities($row_editarfactura['PrecioUni'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" readonly>
  
  </div>
  <div class="col-xs-6 col-sm-3">
  
 <input type="text" name="PrecipTotal" value="<?php echo htmlentities($row_editarfactura['PrecipTotal'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" readonly>
...
<div class="row">
  ...
  <input type="text" name="Precioletra" value="<?php echo htmlentities($row_editarfactura['Precioletra'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" readonly>
  <br><br>
...
<select name="Estado" id="Estado" class="form-control">
  ...
  <input type="text" name="SubTotal" value="<?php echo htmlentities($row_editarfactura['SubTotal'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" readonly><br>
  <input type="text" name="Iva" value="<?php echo htmlentities($row_editarfactura['Iva'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" readonly><br>
  <input type="text" name="Total" value="<?php echo htmlentities($row_editarfactura['Total'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" readonly>
  </div>
</div>
