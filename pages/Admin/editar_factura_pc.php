...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE clientes SET Nombre=%s, Identificacion=%s, Direccion=%s, Email=%s, Telefono=%s, Fecha=%s, Factura=%s, Tipocliente=%s, Cantidad=%s, Cantidad2=%s, Cantidad3=%s, Descripcion=%s, Descripcion2=%s, Descripcion3=%s, PrecioUni=%s, PrecipTotal=%s, PrecioUni2=%s, PrecioUni3=%s, PrecioTotal2=%s, PrecioTotal3=%s, Precioletra=%s, SubTotal=%s, Iva=%s, Total=%s, Estado=%s WHERE Id_cliente=%s",
  ...
  $updateGoTo = "facturas_pacgrafica.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="row">
  ...
  <input type="text" name="Cantidad" value="<?php echo htmlentities($row_editarfactura['Cantidad'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Cantidad" required>
  ...
  <input type="text" name="PrecioUni" value="<?php echo htmlentities($row_editarfactura['PrecioUni'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Valor Unitario" required>
  
  </div>
  <div class="col-xs-6 col-sm-3">
  
  <input type="text" name="PrecipTotal" value="<?php echo htmlentities($row_editarfactura['PrecipTotal'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Precio Total" required>
...
<div class="row">
  ...
  <input type="text" name="Cantidad2" value="<?php echo htmlentities($row_editarfactura['Cantidad2'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Cantidad">
  ...
  <input type="text" name="PrecioUni2" value="<?php echo htmlentities($row_editarfactura['PrecioUni2'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Valor Unitario">
  
  </div>
  <div class="col-xs-6 col-sm-3">
  
  <input type="text" name="PrecioTotal2" value="<?php echo htmlentities($row_editarfactura['PrecioTotal2'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Precio Total">
...
<div class="row">
  ...
  <input type="text" name="Cantidad3" value="<?php echo htmlentities($row_editarfactura['Cantidad3'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Cantidad">
  ...
  <input type="text" name="PrecioUni3" value="<?php echo htmlentities($row_editarfactura['PrecioUni3'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Valor Unitario">
  
  </div>
  <div class="col-xs-6 col-sm-3">
  
  <input type="text" name="PrecioTotal3" value="<?php echo htmlentities($row_editarfactura['PrecioTotal3'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Precio Total">
...
<div class="row">
  ...
  <input type="text" name="Precioletra" value="<?php echo htmlentities($row_editarfactura['Precioletra'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Precio Letra" required>
  
   <br><br>
 
<select name="Estado" id="Estado" class="form-control">
  <option value="Activa" style="color:#090;" <?php if (!(strcmp("Activo", $row_editarfactura['Estado']))) {echo "selected=\"selected\"";} ?>>Activa</option>
  <option value="Anulada" style="color:#F00;" <?php if (!(strcmp("Anulada", $row_editarfactura['Estado']))) {echo "selected=\"selected\"";} ?>>Anulada</option>
</select>
  </div>
  <div class="col-xs-6 col-md-4">
  
  <input type="text" name="SubTotal" value="<?php echo htmlentities($row_editarfactura['SubTotal'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Subtotal" required><br>
  <input type="text" name="Iva" value="<?php echo htmlentities($row_editarfactura['Iva'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="i.v.a" required><br>
  <input type="text" name="Total" value="<?php echo htmlentities($row_editarfactura['Total'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control" placeholder="Total" required>
  </div>
</div>
