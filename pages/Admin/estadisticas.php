...
$MM_restrictGoTo = "error_admin.php";
...
<?php 
	...
	$conexion = mysql_connect("localhost","pacgrafi_cacumen","mastodon2015");
	mysql_select_db("pacgrafi_cacumen",$conexion);
	...
	$sql=mysql_query("SELECT * FROM tareas");
	while($row=mysql_fetch_array($sql)){
		$y=date("Y", strtotime($row['Fecha_Entrega']));
		
		$mes=(int)date("m", strtotime($row['Fecha_Entrega'])); 
		
		if($y==$anno){
			$dinero[$mes]=$dinero[$mes]+$row['Total_cobrado'];
		}
	}
?>
<!DOCTYPE html>
