...
$query_varfactura = "SELECT * FROM clientes ORDER BY clientes.Id_cliente DESC";
...
<div style="z-index:3; position:absolute; margin-top: 550px; margin-left:290px; font-size:20px;"><strong><?php echo $row_varfactura['Descripcion']; ?></strong></div>
...
<div style="z-index:3; position:absolute; margin-top: 650px; margin-left:290px; font-size:20px;"><strong><?php echo $row_varfactura['Descripcion2']; ?></strong></div>
...
<div style="z-index:3; position:absolute; margin-top: 750px; margin-left:290px; font-size:20px;"><strong><?php echo $row_varfactura['Descripcion3']; ?></strong></div>
