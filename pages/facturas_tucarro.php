                  ...
                  <table border="0">
                    <tr>
                      <td><?php if ($pageNum_facturastucarro > 0) { // Show if not first page ?>
                          <a href="<?php printf("%s?pageNum_facturastucarro=%d%s", $currentPage, 0, $queryString_facturastucarro); ?>" class="btn btn-default">Primero</a>
                          <?php } // Show if not first page ?></td>
                      <td><?php if ($pageNum_facturastucarro > 0) { // Show if not first page ?>
                          <a href="<?php printf("%s?pageNum_facturastucarro=%d%s", $currentPage, max(0, $pageNum_facturastucarro - 1), $queryString_facturastucarro); ?>" class="btn btn-default">Anterior</a>
                          <?php } // Show if not first page ?></td>
                      <td><?php if ($pageNum_facturastucarro < $totalPages_facturastucarro) { // Show if not last page ?>
                          <a href="<?php printf("%s?pageNum_facturastucarro=%d%s", $currentPage, min($totalPages_facturastucarro, $pageNum_facturastucarro + 1), $queryString_facturastucarro); ?>" class="btn btn-default">Siguiente</a>
                          <?php } // Show if not last page ?></td>
                      <td><?php if ($pageNum_facturastucarro < $totalPages_facturastucarro) { // Show if not last page ?>
                          <a href="<?php printf("%s?pageNum_facturastucarro=%d%s", $currentPage, $totalPages_facturastucarro, $queryString_facturastucarro); ?>" class="btn btn-default">&Uacute;ltimo</a>
                          <?php } // Show if not last page ?></td>
                    </tr>
                  </table>
