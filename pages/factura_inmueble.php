...
$varinmueble_tuinmueble = "0";
if (isset($_GET["recordID"])) {
  $varinmueble_tuinmueble = $_GET["recordID"];
}
mysql_select_db($database_sistemapacgrafica, $sistemapacgrafica);
$query_tuinmueble = sprintf("SELECT * FROM plantuinmueble WHERE plantuinmueble.Id_tarifa = %s", GetSQLValueString($varinmueble_tuinmueble, "int"));
$tuinmueble = mysql_query($query_tuinmueble, $sistemapacgrafica) or die(mysql_error());
$row_tuinmueble = mysql_fetch_assoc($tuinmueble);
$totalRows_tuinmueble = mysql_num_rows($tuinmueble);
...
<head>
    ...
    <title>Factura tu inmueble</title>
      ...
      <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Publicación <?php echo $row_tuinmueble['Tipo']; ?></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                <img src="../images/tuinmueble.png" width="400" height="72"><br><br>
    <!-- /.buscador -->
...
<textarea name="Descripcion" cols="50" rows="5" class="form-control"><?php echo $row_tuinmueble['Descripcion_publicacion']; ?></textarea>
  ...
  <input type="text" name="PrecioUni" value="<?php echo $row_tuinmueble['Valor_unitario']; ?>" size="32" class="form-control" readonly>
  
  </div>
  <div class="col-xs-6 col-sm-3">
  
 <input type="text" name="PrecipTotal" value="<?php echo $row_tuinmueble['Precio_total']; ?>" size="32" class="form-control" readonly>
...
<div class="row">
  ...
  <input type="text" name="Precioletra" value="<?php echo $row_tuinmueble['Valor en letra']; ?>" size="32" class="form-control" readonly>
  ...
  <input type="text" name="SubTotal" value="<?php echo $row_tuinmueble['Subtotal']; ?>" size="32" class="form-control" readonly><br>
  <input type="text" name="Iva" value="<?php echo $row_tuinmueble['Iva']; ?>" size="32" class="form-control" readonly><br>
  <input type="text" name="Total" value="<?php echo $row_tuinmueble['Total']; ?>" size="32" class="form-control" readonly>
  </div>
</div>
