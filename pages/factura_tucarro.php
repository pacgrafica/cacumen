...
$vartucarro_tucarro = "0";
if (isset($_GET["recordID"])) {
  $vartucarro_tucarro = $_GET["recordID"];
}

mysql_select_db($database_sistemapacgrafica, $sistemapacgrafica);
$query_tucarro = sprintf("SELECT * FROM plantucarro WHERE plantucarro.Id_tarifa = %s", GetSQLValueString($vartucarro_tucarro, "int"));
$tucarro = mysql_query($query_tucarro, $sistemapacgrafica) or die(mysql_error());
$row_tucarro = mysql_fetch_assoc($tucarro);
$colname_tucarro = "-1";
if (isset($_GET['recordID'])) {
  $colname_tucarro = $_GET['recordID'];
}
mysql_select_db($database_sistemapacgrafica, $sistemapacgrafica);
$query_tucarro = sprintf("SELECT * FROM plantucarro WHERE Id_tarifa = %s", GetSQLValueString($colname_tucarro, "int"));
$tucarro = mysql_query($query_tucarro, $sistemapacgrafica) or die(mysql_error());
$row_tucarro = mysql_fetch_assoc($tucarro);
$totalRows_tucarro = mysql_num_rows($tucarro);
      ...
      <?php include("includes/menu.php"); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Publicación <?php echo $row_tucarro['Tipo']; ?></h1>
                    </div>
                    <!-- /.col-lg-12 -->      
                    <img src="../images/tucarro.png" width="400" height="69"><br><br>        
...
<div class="row">
  ...
  <textarea name="Descripcion" cols="50" rows="5" class="form-control"><?php echo $row_tucarro['Descripcion_publicacion']; ?></textarea>
  ...
  <input type="text" name="PrecioUni" value="<?php echo $row_tucarro['Valor_unitario']; ?>" size="32" class="form-control" readonly>
  
  </div>
  <div class="col-xs-6 col-sm-3">
  
 <input type="text" name="PrecipTotal" value="<?php echo $row_tucarro['Precio_total']; ?>" size="32" class="form-control" readonly>
...
<div class="row">
  ...
  <input type="text" name="Precioletra" value="<?php echo $row_tucarro['Valor en letra']; ?>" size="32" class="form-control" readonly>
  ...
  <input type="text" name="SubTotal" value="<?php echo $row_tucarro['Subtotal']; ?>" size="32" class="form-control" readonly><br>
  <input type="text" name="Iva" value="<?php echo $row_tucarro['Iva']; ?>" size="32" class="form-control" readonly><br>
  <input type="text" name="Total" value="<?php echo $row_tucarro['Total']; ?>" size="32" class="form-control" readonly>
  </div>
</div>
